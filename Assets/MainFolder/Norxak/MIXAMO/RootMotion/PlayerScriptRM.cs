...
public class PlayerScriptRM : MonoBehaviour
{
    //debug
    ...
    void Movement()
    {
        ...
        Vector3 movementDirection = new Vector3( hInput, 0, vInput);//jumpDir + forwardMovement + rightMovement;
        float movementMag = Mathf.Clamp01(movementDirection.magnitude);

        playerAnimator.SetFloat("rmVelocity", movementMag, 0.05f, Time.deltaTime);
    ...
    {
        Vector3 velo = playerAnimator.deltaPosition;
        //velo.y = jumpSpeed * Time.deltaTime;
